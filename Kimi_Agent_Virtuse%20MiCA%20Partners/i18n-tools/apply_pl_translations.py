#!/usr/bin/env python3
"""Apply the EN->PL copy in pl_translations.py to the scaffolded pl/ pages.
...
Usage: python3 i18n-tools/apply_pl_translations.py [page.html ...]
"""
import html
import os
import re
...
import pl_translations as T  # noqa: E402
