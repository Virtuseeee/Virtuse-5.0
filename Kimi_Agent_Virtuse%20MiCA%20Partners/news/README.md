...
This is a static page plus JSON the desk can edit. It is not a clone of virtuse.com and not the dark Phase 1 Virtuse News theme.
...
| `../satoshi-lockup.png` | Header wordmark (face + “satoshi”). Do not swap in the old PDF that spelled “satosi”. |
