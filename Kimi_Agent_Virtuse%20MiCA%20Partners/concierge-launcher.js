...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '@media (max-width:520px){.vc-bubble{right:12px;bottom:12px;padding:4px;',
      'gap:0;background:rgba(23,23,26,0.55);backdrop-filter:blur(6px);',
      '-webkit-backdrop-filter:blur(6px);opacity:0.7;',
      'transition:opacity .2s ease,transform .15s ease,box-shadow .15s ease;}',
      '.vc-bubble:active,.vc-bubble:focus-visible{opacity:1;background:#17171a;}',
      '.vc-bubble-icon{width:34px;height:34px;font-size:15px;}',
